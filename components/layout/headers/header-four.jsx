...
const HeaderFour = () => {
    ...
    const headerClass = isSticky ? 'header__area header__sticky-active' : 'header__four';
                ...
                <div className="custom_container">
                    <div className="header__area-menubar">
                        ...
                        <div className="header__area-menubar-center">
                            <div className={`header__area-menubar-center-menu ${isSticky ? 'header__area-menu-style' : 'header__four-menu-style'}`}>
                                <MainMenu />
                            </div>
                        </div>
